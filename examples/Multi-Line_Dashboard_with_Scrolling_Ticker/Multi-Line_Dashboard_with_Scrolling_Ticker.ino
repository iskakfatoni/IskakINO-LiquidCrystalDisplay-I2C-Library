/*
  Multi-Line Dashboard with Scrolling Ticker
  -------------------------------------------

  Demonstrates a multi-line dashboard on a 20x4 LCD using I2C (PCF8574) with a scrolling ticker on line 4.
  ...
  - Scrolling ticker updates independently
...
const long interval = 1000; // update sensor every 1 second
...
String tickerMessage = "ALERT: Check water level! | System running smoothly... | ";
...
void loop() {
  ...
  // --- Update sensor lines every 1 second ---
